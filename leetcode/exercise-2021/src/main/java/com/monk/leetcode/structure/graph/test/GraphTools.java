package com.monk.leetcode.structure.graph.test;

import com.monk.leetcode.structure.graph.Graph;
import com.monk.leetcode.structure.graph.ListGraph;

/**
 * 渲染图工具类
 */
public class GraphTools<E> {

    /**
     * 渲染有向图
     */
    public static Graph<Object, Double> directedGraph(Object[][] data, Graph.WeightManager weightManager) {
